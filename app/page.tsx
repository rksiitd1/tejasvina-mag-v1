...
export default function TejasvinaMagazine() {
  ...
  useEffect(() => {
    const handleScroll = () => {
      setIsScrolled(typeof window !== 'undefined' && window.scrollY > 50)
    }
      ...
      <div className="space-y-0 relative z-10">
        ...
        <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
          ...
          <div className="absolute inset-0 overflow-hidden">
            {[...Array(8)].map((_, i) => (
              <div
                ...
                style={{
                  left: `${[15, 25, 75, 85, 35, 65, 45, 55][i]}%`,
                  top: `${[20, 60, 30, 70, 80, 10, 40, 90][i]}%`,
                  animationDelay: `${i * 0.8}s`,
                  animationDuration: `${6 + (i % 3) * 2}s`,
                }}
              >
                <div className={`w-12 h-12 border border-amber-400/30 rounded-full opacity-40`}>
                  <div className="w-full h-full border border-rose-400/20 rounded-full animate-spin-slow">
          ...
          <div className="relative z-10 text-center text-white px-4 max-w-6xl mx-auto">
            <div className="mb-12">
              ...
              <div className="mb-8 relative">
                <h1 className="text-8xl md:text-[12rem] font-bold mb-4 relative group">
                  <span className="bg-gradient-to-r from-amber-300 via-rose-300 to-indigo-300 bg-clip-text text-transparent font-serif tracking-wider transition-all duration-3000 group-hover:from-amber-200 group-hover:via-rose-200 group-hover:to-indigo-200">
                    तेजस्विना
                  </span>
                  <div className="absolute inset-0 bg-gradient-to-r from-amber-400/10 via-rose-400/10 to-indigo-400/10 rounded-full blur-3xl animate-pulse opacity-0 group-hover:opacity-100 transition-opacity duration-2000"></div>
                </h1>
              ...
              <div className="flex flex-col sm:flex-row gap-6 justify-center items-center mt-12">
                <Button
                  size="lg"
                  className="group bg-gradient-to-r from-amber-600 via-rose-600 to-indigo-600 hover:from-amber-700 hover:via-rose-700 hover:to-indigo-700 text-white px-12 py-4 text-lg font-medium rounded-full shadow-2xl hover:shadow-amber-500/25 transition-all duration-700 border border-amber-400/30 hover:scale-105 hover:border-amber-400/60 active:scale-95"
                >
                  <Lotus className="mr-3 h-5 w-5 group-hover:rotate-12 transition-transform duration-500" />
                  Explore Consciousness
                  <ArrowRight className="ml-3 h-5 w-5 group-hover:translate-x-1 transition-transform duration-500" />
                </Button>
                <Button
                  size="lg"
                  variant="outline"
                  className="border-2 border-amber-400/50 text-amber-100 hover:bg-amber-400/10 hover:text-white px-12 py-4 text-lg bg-transparent backdrop-blur-sm rounded-full font-medium hover:scale-105 hover:border-amber-400/80 active:scale-95 transition-all duration-700"
                >
          ...
          <div className="absolute bottom-10 left-1/2 transform -translate-x-1/2 group cursor-pointer">
            <div className="flex flex-col items-center text-amber-200 group-hover:text-amber-100 transition-colors duration-1000">
              <div className="w-6 h-10 border-2 border-amber-400/50 rounded-full flex justify-center mb-2 group-hover:border-amber-400/80 transition-colors duration-1000">
                <div className="w-1 h-3 bg-amber-400 rounded-full mt-2 animate-bounce group-hover:bg-amber-300"></div>
              </div>
              <span className="text-xs font-light tracking-wider opacity-70 group-hover:opacity-100 transition-opacity duration-1000">
                SCROLL TO ENLIGHTEN
              </span>
              <div className="w-8 h-px bg-gradient-to-r from-transparent via-amber-400/30 to-transparent mt-2 opacity-0 group-hover:opacity-100 transition-opacity duration-1000"></div>
            </div>
          </div>
        </section>
            ...
            <div className="grid lg:grid-cols-3 gap-8">
              {featuredArticles.map((article, index) => (
                ...
                >
                  ...
                  {/* Sacred Center Point */}
                  <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-1 h-1 bg-amber-400 rounded-full opacity-0 group-hover:opacity-60 transition-all duration-1000 group-hover:scale-[20] group-hover:bg-amber-400/5"></div>
